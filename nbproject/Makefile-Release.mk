...
${OBJECTDIR}/CategoriaSUB.o: CategoriaSUB.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CategoriaSUB.o CategoriaSUB.c

${OBJECTDIR}/CategoriaXML.o: CategoriaXML.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CategoriaXML.o CategoriaXML.c
...
${OBJECTDIR}/ContasMenu.o: ContasMenu.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ContasMenu.o ContasMenu.c
...
${OBJECTDIR}/HotelSub.o: HotelSub.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HotelSub.o HotelSub.c
...
${OBJECTDIR}/MenuEntradaProdutos.o: MenuEntradaProdutos.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MenuEntradaProdutos.o MenuEntradaProdutos.c

${OBJECTDIR}/MenuRelatorio.o: MenuRelatorio.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MenuRelatorio.o MenuRelatorio.c
...
${OBJECTDIR}/ReservaMenu.o: ReservaMenu.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReservaMenu.o ReservaMenu.c

${OBJECTDIR}/ReservaSubC.o: ReservaSubC.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReservaSubC.o ReservaSubC.c

${OBJECTDIR}/ReservaSubCancel.o: ReservaSubCancel.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReservaSubCancel.o ReservaSubCancel.c
...
${OBJECTDIR}/Tag.o: Tag.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tag.o Tag.c
...
${OBJECTDIR}/csvContasRec.o: csvContasRec.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/csvContasRec.o csvContasRec.c
...
${OBJECTDIR}/menuXML.o: menuXML.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/menuXML.o menuXML.c

${OBJECTDIR}/xml.o: xml.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/xml.o xml.c
