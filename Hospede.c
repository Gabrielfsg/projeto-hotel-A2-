...
void cadastrarHospedesTXT(Hospede h) {
    FILE* listaHospedes;
    listaHospedes = fopen(".\\persist\\hospedess.txt", "a");
...
Hospede* getAllHospedes(int numHospedes) {
    ...
    scanHospedes = fopen(".\\persist\\hospedess.txt", "r");
...
void sobrescreverHospedesTXT(int cod) {
    ...
    Hospede* arrayHospedes = getAllHospedes(3);
